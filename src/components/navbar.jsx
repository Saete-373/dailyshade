            ...
            <div className="px-10">
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex items-center justify-end gap-4">
                            ...
                            <img onClick={toggleDropdown} id="dropdownButton" className="h-10 w-auto inline-block rounded-full hover:ring-2" src={png} alt=""></img>
                            <div id="dropdown" className=" divide-y rounded border-[1px] border-gray-300 bg-white py-3 px-4 absolute top-14 max-w-64 w-64 shadow-md text-left hidden">
                                <ul>
                                ...
                                <ul>
                                    <li class="flex rounded hover:bg-gray-300 p-2 max-w-full">
                                        <label class="inline-flex items-center w-full space-x-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                            <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" />
                                            </svg>
                                            <span class="cursor-pointer">บัญชีของฉัน</span>
                                        </label>
                                    </li>
                                    <li class="flex rounded hover:bg-gray-300 p-2 max-w-full">
                                        <label class="inline-flex items-center w-full space-x-2">
                                            ...
                                            <span class="cursor-pointer">การตั้งค่า</span>
                                        </label>
                                    </li>
                                    <li class="flex rounded hover:bg-gray-300 p-2 max-w-full">
                                        <label class="inline-flex items-center w-full space-x-20">
                                            <div className="flex space-x-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                                <path fill-rule="evenodd" d="M9.528 1.718a.75.75 0 0 1 .162.819A8.97 8.97 0 0 0 9 6a9 9 0 0 0 9 9 8.97 8.97 0 0 0 3.463-.69.75.75 0 0 1 .981.98 10.503 10.503 0 0 1-9.694 6.46c-5.799 0-10.5-4.7-10.5-10.5 0-4.368 2.667-8.112 6.46-9.694a.75.75 0 0 1 .818.162Z" clip-rule="evenodd" />
                                                </svg>
                                                <span class="cursor-pointer">โหมดมืด</span>   
                                            </div>
                                            <input type="checkbox" value="" class="sr-only peer"/>
                                            <div class="relative w-9 h-5 bg-gray-400 peer-focus:outline-none  rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full rtl:peer-checked:after:translate-x-[-100%] peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-500 peer-checked:bg-black"></div>
                                        </label>
                                    </li>
                                </ul>
                                <ul>
                                    <li class="flex rounded hover:bg-gray-300 p-2 max-w-full">
                                        <label class="inline-flex items-center w-full space-x-2">
                                            ...
                                            <span class="cursor-pointer">คำถามที่พบบ่อย</span>
                                        </label>
                                    </li>
                                    <li class="flex rounded hover:bg-gray-300 p-2 max-w-full">
                                        <label class="inline-flex items-center w-full space-x-2">
                                            ...
                                            <span class="cursor-pointer">ติดต่อเรา</span>
                                        </label>
                                    </li>
                                </ul>
                                <ul>
                                    <li class="flex rounded hover:bg-gray-300 p-2 max-w-full">
                                            <label class="inline-flex items-center w-full space-x-2">
                                                ...
                                                <span class="cursor-pointer text-red-600">ออกจากระบบ</span>
                                            </label>
                                        </li>
                                </ul>
                            </div>
