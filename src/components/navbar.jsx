          ...
          <div className="flex items-center justify-between ">
            ...
            <div className="flex items-center justify-end gap-4">
              {/* <div className="flex gap-2">
                                <a className=" items-center justify-center rounded-full bg-white px-3 py-2 text-sm  text-text-color shadow-sm ring-1 ring-inset ring-gray-300 transition-all duration-150 hover:bg-pink-darker sm:inline-flex"
                                href="/">สมัครบัญชี</a>
                ...
                <ul>
                  <li className="flex rounded hover:bg-gray-300 p-2 max-w-full">
                    <label className="inline-flex items-center w-full space-x-2">
                      ...
                      <span className="cursor-pointer">บัญชีของฉัน</span>
                    </label>
                  </li>
                  <li className="flex rounded hover:bg-gray-300 p-2 max-w-full">
                    <label className="inline-flex items-center w-full space-x-2">
