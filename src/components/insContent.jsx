      ...
      <main className="lg:flex lg:flex-row ipad:flex-col justify-center bg-white/30 border-2 border-y-white p-12 gap-x-40 w-screen ipad:w-50 ">
        <div className="flex flex-col justify-center place-items-center ">
          <a
            ...
            target="_blank"
            className="text-gray-900 hover:text-ins-color dark:hover:text-white dark:text-gray-400 pb-3"
          >
            <svg
              className="w-20 h-20"
              fill="currentColor"
          ...
          <h1 className="font-serif text-4xl uppercase font-light text-text-color ">
            Instagram
          </h1>
        </div>
