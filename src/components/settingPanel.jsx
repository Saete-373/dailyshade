...
function toggletabs() {
  document.querySelectorAll("#tabs [tab-to]").forEach(function (item) {
    item.addEventListener("click", function (e) {
      const link = this.getAttribute("tab-to");
    ...
    <>
      <div className="flex max-w-screen justify-center">
        <div className="flex flex-row justify-center w-9/12 max-h-full h-screen place-items-center">
          <div className="w-1/4 max-h-screen h-5/6 border-2 border-black-50 rounded-l-xl gap-5 bg-slate-100">
          ...
          <div
            className="w-3/4 max-h-screen h-5/6 border-2 border-black-50 rounded-e-xl gap-5 bg-slate-100"
            id="tab-contents"
          >
